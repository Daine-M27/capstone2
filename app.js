...
app.post('/api/gallery', passportConfig.isAuthenticated, galleryController.postGallery);
...
app.delete('/api/gallery/:id', passportConfig.isAuthenticated, galleryController.deleteGallery);
